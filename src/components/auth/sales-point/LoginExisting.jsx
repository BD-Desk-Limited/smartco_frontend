    ...
    <div className="w-[85%] h-[80%] bg-white rounded-md shadow-md flex flex-col items-center justify-center p-5">
      <div className="flex flex-row items-center gap-5 w-full">
        <p
          ...
          className="px-3 py-3 bg-gray-shadow9 rounded-[100%] cursor-pointer hover:bg-gray-shadow8"
        >
          <Image
        ...
        <h1 className="flex text-xl font-bold w-full justify-center items-center text-center text-brand-green">
          Welcome Back!
        </h1>
      </div>
      <div className="flex flex-col gap-5 items-center w-full justify-center">
        ...
        <span className="text-base w-full text-brand-green font-semibold">
          {seller?.name}
        </span>
        <div className="w-full flex flex-col text-left">
          <label
            htmlFor="pin"
            className="text-base text-brand-green font-semibold w-full text-left"
          >
            Pin
          </label>
        ...
        <button
          ...
          className={`h-10 w-full bg-brand-green rounded-md text-lg text-white ${
