  ...
  return (
    <div className="flex flex-row gap-0 bg-background-1">
      ...
      <div className="w-full max-h-[100vh] overflow-y-auto no-scrollbar">
        <BulkBranchesUploadReview pageDescription={pageDescription} />
      </div>
    </div>
  );
};
