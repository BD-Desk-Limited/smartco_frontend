...
import BranchUploadInstructions from './BranchUploadInstructions';
...
const BulkBranchUploadModal = () => {
  ...
  const instructions = [
    'For fast and seamless creation of branches in bulk, we have provided a template for you to fill and upload.',
    'Warning: Do not alter any part of the headings, and ensure the correct template is used.',
  ];
  ...
  return (
    <>
      <div className="bg-text-white rounded-md flex flex-col justify-center items-center w-[35vw]">
        ...
        <div className="h-[45vh] flex flex-col justify-center items-center gap-8 w-full px-10">
          ...
          <button
            ...
            className="text-brand-blue hover:underline flex items-center gap-2 text-sm shadow-md px-3 py-2 rounded-md bg-blue-shadow9"
          >
            <Image
              src="/assets/info.png"
              width={20}
