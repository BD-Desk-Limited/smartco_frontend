                ...
                <div className=" flex flex-col gap-5 w-full">
                  ...
                  <div className="flex gap-1 flex-col w-full">
                    ...
                    <select
                      ...
                      className="border border-gray-border rounded-md p-2 w-80 focus:outline-none text-sm text-text-gray focus:ring-2 focus:ring-brand-blue"
                    >
                      ...
                      !cantFindCategory ? (
                        <div className="flex gap-1 flex-col">
                          ...
                          <span
                            ...
                            className="text-sm font-semibold text-brand-blue cursor-pointer hover:underline"
                          >
                ...
                <div className=" flex flex-col gap-7 w-full">
                  <div className="flex gap-1 flex-col w-full">
                    ...
                    <textarea
                      ...
                      className="border border-gray-border rounded-md p-2 w-full focus:outline-none text-sm text-text-gray h-24 focus:ring-2 focus:ring-brand-blue"
                    />
                  </div>
                  <div className="flex gap-1 flex-col">
                    {!unitCreated ? (
                        ...
                        <div className="flex gap-1 flex-col">
                          ...
                          <div className="flex gap-1 flex-col">
                            ...
                            <span
                              ...
                              className="text-sm hover:underline font-semibold text-brand-blue cursor-pointer"
                            >
