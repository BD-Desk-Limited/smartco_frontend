...
const BulkMaterialsUpload = () => {
  ...
  const { setBulkMaterialData } = useBulkMaterialUpload();
  ...
  React.useEffect(() => {
    if(success){
      Router.push('/pages/account/admin/manage-materials/bulk-upload-review');
    };
  }, [success, Router]);

  return (
    <div className="bg-background-1 p-5 my-2 rounded-md h-full flex flex-col justify-center items-center">
