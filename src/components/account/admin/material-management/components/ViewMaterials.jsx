...
const ViewMaterial = ({ pageDescription }) => {
  ...
  const allCategories = [
    ...new Set(allMaterials.map((material) => material.category?.name)),
  ];
  const allMaterialTypes = [
    ...new Set(allMaterials.map((material) => material.materialType)),
  ];
          ...
          <div className="bg-white p-5 mx-5 my-2 rounded-md h-full flex flex-col gap-5">
            <div className="flex flex-row gap-5 w-full justify-between items-center">
              ...
              <div className="flex flex-row gap-2 text-sm min-w-fit text-text-gray">
                ...
                <button>
                  <Link
                    href="/pages/account/admin/manage-materials/create-material"
                        ...
                        {filteredMaterials.map((material) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-2 flex flex-row w-full justify-between">
                              <Link
                                href={`/pages/account/admin/manage-materials/edit-material?id=${material._id}`}
                                title="Edit Material"
                              >
                                <Image
                                  src="/assets/edit.png"
