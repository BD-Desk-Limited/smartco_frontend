...
const SelectComponents = ({
  ...
  bands,
  showSelectComponents,
  setShowSelectComponents,
}) => {
  ...
  const rawMaterials = safeMaterials.filter(
    (mat) => mat.materialType === 'raw-material'
  );
  const packagings = safeMaterials.filter(
  ...
  const handleAddAlternate = (material, compIndex) => {
    setProducts((prev) => {
      ...
      const already = targetComp.materialChoices.some(
        (mc) => mc.material === material._id
      );
      if (!already) {
  ...
  return (
    <div className="min-h-[40vh] flex flex-col py-3 px-1 w-full items-center gap-2 relative">
      <span className="text-base font-semibold text-white w-full text-center">
        Select the components that make up this product
      </span>
      ...
      {!showSelectComponents[productIndex] ||
          ...
          <div className="w-1/2 flex flex-col">
            ...
            <div className="flex flex-wrap gap-2 max-h-40 overflow-y-auto mt-2 scrollbar-thin">
              ...
              {filteredMaterials.length === 0 && (
                <div className="text-red-400 text-sm">No materials found!</div>
              )}
            </div>
          </div>
          ...
          <div className="w-1/2 flex flex-col">
            ...
            <div className="flex flex-wrap gap-2 max-h-40 overflow-y-auto mt-2 scrollbar-thin">
              ...
              {filteredPackagings.length === 0 && (
                <div className="text-red-400 text-sm">No packaging found!</div>
              )}
            </div>
          </div>
        </div>
                                ...
                                >
                                  ...
                                  <input
                                    ...
                                    value={
                                      ...
                                      band.price === null ||
                                      band.price === undefined
                                        ? ''
                                        : parseFloat(band.price)
                                    }
                                    onChange={(e) =>
                                      handleUpdateBandPrice(
                                        compIdx,
                                        choiceIdx,
                                        bandIdx,
                                        parseFloat(e.target.value)
                  ...
                  <div className="mt-2">
                    {!openAltSearch ? (
                      <span className="text-sm text-gray-200 cursor-pointer">
                        ...
                        <button
                          onClick={() => setOpenAltSearch(true)}
                          className="text-brand-blue bg-text-white p-1 rounded ml-1 hover:bg-blue-shadow1 shadow-md hover:text-text-white"
                        >
                          Add alternatives
                        </button>
                      </span>
